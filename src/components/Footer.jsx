        ...
        <div className="footer__container  false" style={{ color: 'rgb(255, 255, 255)', background: 'rgb(20, 20, 20)' }}>
            <div className="footer__wapper">
                <div className="footer__top">
                    ...
                    <div className="footer__top-more">
                        <span onClick={() => handleNavigation('/viec-lam-cua-hang/store')} >Việc làm cửa hàng</span>
                        <span onClick={() => handleNavigation('/viec-lam-van-phong/office')}>Việc làm văn phòng</span>
                        <span onClick={() => handleNavigation('/tra-cuu-ket-qua')}>Tra cứu kết quả</span>
                    </div>
                </div>
            ...
            <div className="footer-mb__wrapper">
                <div className="footer__tab">
                    <div className={`footer__tab-item ${isActive('/viec-lam-cua-hang/store') ? 'active' : ''}`} onClick={() => handleNavigation('/viec-lam-cua-hang/store')}>
                    ...
                    <div className={`footer__tab-item ${isActive('/viec-lam-van-phong/office') ? 'active' : ''}`} onClick={() => handleNavigation('/viec-lam-van-phong/office')}>
                        <span className="footer__tab-item-icon">
                    ...
                    <div className={`footer__tab-item ${isActive('/tra-cuu-ket-qua') ? 'active' : ''}`}  onClick={() => handleNavigation('/tra-cuu-ket-qua')}>
                        <span className="footer__tab-item-icon">
                            <svg width="20px" height="20px" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
