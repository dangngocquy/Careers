...
function Vieclam() {
    const { workBlock, title } = useParams();
    ...
    useEffect(() => {
        async function fetchJobData() {
            try {
                ...
                if (workBlock === 'store') {
                    q = query(jobsRef, where('title', '==', title));
                } else {
                    q = query(jobsRef,
                        where('workBlock', '==', workBlock),
                        where('title', '==', title)
                    );
                }
    ...
    const relatedJobs = jobs
        .filter(job => job.workBlock === jobData.workBlock && job.title !== jobData.title)
        .slice(0, 5);

    const handleJobClick = (job) => {
        const workBlockLabel = job.workBlock ? 'Khối cửa hàng' : 'Khối văn phòng';
    ...
    return (
        <div className="job-detail__container ">
            ...
            <div className="job-detail__wapper">
                <div className="job-detail__body">
                    <div className="job-detail__main">
                        <div className="job-detail__apply-container-mb">
                            <h1 className="job-detail__name-apply">{jobData.title}</h1>
                            <div className="job-detail__btn-apply" onClick={(e) => handleApplyClick(e, jobData.title)}>Ứng tuyển</div>
                        </div>
                        <div className="job-detail__hob-info-mb">
                        ...
                        <h1 className="job-detail__name">{jobData.title}</h1>
                        <div className="job-detail__description">
                            <div className="job-detail__description-title">Mô tả công việc</div>
                            <div>
                                <div className="hrv-content-editor--container">
                                    <div className="hrv-content-editor--readonly" dangerouslySetInnerHTML={{ __html: jobData.description }}>
                                    </div>
                                </div>
                            </div>
                            {jobData.requirements && jobData.requirements.trim() !== "" && (
                                <>
                                    <p>&nbsp;</p>
                                    <p>&nbsp;</p>
                                    <div className="job-detail__description-title">Yêu cầu công việc</div>
                                    <div>
                                        <div className="hrv-content-editor--container">
                                            <div className="hrv-content-editor--readonly" dangerouslySetInnerHTML={{ __html: jobData.requirements }}>
                                            </div>
                                        </div>
                                    </div>
                                </>
                                ...
                                <div className="job-list__item" onClick={() => handleJobClick(job)} key={index}>
                                    ...
                                    <div className="job-list__item-body">
                                        ...
                                        <div className="job-list__item-right">
                                            ...
                                            <div className="job-list__item-btn-apply"  onClick={(e) => handleApplyClick(e, jobData.title)} >Ứng tuyển ngay</div>
                                        </div>
                                    </div>
                                </div>
                            ))}
                ...
                <div className="job-detail__apply-container">
                    <div className="job-detail__apply-wapper">
                        ...
                        <div className="job-detail__btn-apply" onClick={(e) => window.location.href = `/ung-tuyen-viec-lam/${jobData.title}`}>Ứng tuyển</div>
                    </div>
                </div>
            </div>
        </div>
